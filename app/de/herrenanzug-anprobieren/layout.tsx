...
const data = localizedLandings['virtual-mens-suit-try-on']['de'];
const pageUrl = nativeLandingUrl('virtual-mens-suit-try-on', 'de');
const enUrl = nativeLandingUrl('virtual-mens-suit-try-on', 'en');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-mens-suit-try-on', 'de'),
  ...
  openGraph: {
    ...
    locale: 'de_DE',
    images: [{ url: '/og/virtual-mens-suit-try-on.png', width: 1200, height: 630, alt: 'de herrenanzug anprobieren — Agalaz AI Virtual Try-On' }],
