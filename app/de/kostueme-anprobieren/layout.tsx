...
const data = localizedLandings['virtual-costume-try-on']['de'];
const pageUrl = nativeLandingUrl('virtual-costume-try-on', 'de');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-costume-try-on', 'de'),
  ...
  openGraph: {
    ...
    locale: 'de_DE',
    images: [{ url: '/og/virtual-costume-try-on.png', width: 1200, height: 630, alt: 'de kostueme anprobieren — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
