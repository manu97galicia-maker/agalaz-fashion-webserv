...
const pageUrl = nativeLandingUrl('virtual-wedding-dress-try-on', 'de');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-wedding-dress-try-on', 'de'),
  ...
  openGraph: {
    ...
    locale: 'de_DE',
    images: [{ url: '/og/virtual-wedding-dress-try-on.png', width: 1200, height: 630, alt: 'de brautkleid anprobieren — Agalaz AI Virtual Try-On' }],
