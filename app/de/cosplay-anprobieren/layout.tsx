...
const data = localizedLandings['virtual-cosplay-try-on']['de'];
const pageUrl = nativeLandingUrl('virtual-cosplay-try-on', 'de');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-cosplay-try-on', 'de'),
  ...
  openGraph: {
    ...
    locale: 'de_DE',
    images: [{ url: '/og/virtual-cosplay-try-on.png', width: 1200, height: 630, alt: 'de cosplay anprobieren — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
