...
const data = localizedLandings['virtual-pet-clothing-try-on']['de'];
const pageUrl = nativeLandingUrl('virtual-pet-clothing-try-on', 'de');
const enUrl = nativeLandingUrl('virtual-pet-clothing-try-on', 'en');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-pet-clothing-try-on', 'de'),
  ...
  openGraph: {
    ...
    locale: 'de_DE',
    images: [{ url: '/og/virtual-pet-clothing-try-on.png', width: 1200, height: 630, alt: 'de haustierkleidung anprobieren — Agalaz AI Virtual Try-On' }],
