...
const FAQ = [
  ...
  {
    q: 'इसकी कीमत क्या है?',
    a: 'पहली दो ट्राय बिल्कुल मुफ्त, बिना क्रेडिट कार्ड के। इसके बाद: Starter प्लान $4.99 (10 तस्वीरें, $0.50 प्रति तस्वीर) या Style Pro $9.99 (25 तस्वीरें, $0.40 प्रति तस्वीर — 20% बचत)। एक बार का भुगतान, कोई सब्सक्रिप्शन नहीं।',
  },
  {
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white text-slate-900 font-[family-name:var(--font-noto-hi)]">
      ...
      <TriptychDemo slug="virtual-saree-try-on" labels={TRIPTYCH_LABELS_HI} />
