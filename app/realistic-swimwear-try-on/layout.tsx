...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: 'Agalaz',
    type: 'website',
    images: [{ url: '/og/realistic-swimwear-try-on.png', width: 1200, height: 630, alt: 'Realistic Virtual Swimwear Try-On | Agalaz AI' }],
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <HowToSchemaScript slug="realistic-swimwear-try-on" lang="en" pageUrl="https://agalaz.com/realistic-swimwear-try-on" />
      {children}
    </>
  );
}
