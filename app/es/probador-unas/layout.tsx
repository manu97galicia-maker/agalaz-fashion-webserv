...
const data = localizedLandings['virtual-nail-try-on']['es'];
const pageUrl = nativeLandingUrl('virtual-nail-try-on', 'es');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-nail-try-on', 'es'),
  ...
  openGraph: {
    ...
    locale: 'es_ES',
    images: [{ url: '/og/virtual-nail-try-on.png', width: 1200, height: 630, alt: 'es probador unas — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
