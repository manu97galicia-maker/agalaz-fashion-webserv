...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // Round 10 KD 0 long-tails captured via new H2 sections
    'vestido invitada boda largo',
    'vestido invitada boda barato',
    'vestido invitada boda baratos',
    'vestido invitada boda dia',
    'vestido invitada boda noche',
    'vestido madrina boda',
    'vestido madrina',
    'vestido invitada boda corte ingles',
    'vestido invitada boda 2026',
  ],
