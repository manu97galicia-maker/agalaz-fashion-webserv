...
const data = localizedLandings['virtual-costume-try-on']['es'];
const pageUrl = nativeLandingUrl('virtual-costume-try-on', 'es');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-costume-try-on', 'es'),
  ...
  openGraph: {
    ...
    locale: 'es_ES',
    images: [{ url: '/og/virtual-costume-try-on.png', width: 1200, height: 630, alt: 'es probador disfraces — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
