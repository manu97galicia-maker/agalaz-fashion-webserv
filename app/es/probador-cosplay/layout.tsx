...
const data = localizedLandings['virtual-cosplay-try-on']['es'];
const pageUrl = nativeLandingUrl('virtual-cosplay-try-on', 'es');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-cosplay-try-on', 'es'),
