...
const data = localizedLandings['virtual-mens-suit-try-on']['es'];
const pageUrl = nativeLandingUrl('virtual-mens-suit-try-on', 'es');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-mens-suit-try-on', 'es'),
  ...
  openGraph: {
    ...
    locale: 'es_ES',
    images: [{ url: '/og/virtual-mens-suit-try-on.png', width: 1200, height: 630, alt: 'es probador traje hombre — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
