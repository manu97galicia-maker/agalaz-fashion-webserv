...
export const metadata: Metadata = {
  title: 'Bañador Mujer 2026 — Bikini, Tankini · Probador IA Gratis',
  ...
  openGraph: {
    ...
    locale: 'es_ES',
    images: [{ url: '/og/realistic-swimwear-try-on.png', width: 1200, height: 630, alt: 'Probador Virtual de Bañadores Realista — IA Gratis | Agalaz' }],
    },
};
