...
const data = localizedLandings['virtual-hairstyle-try-on']['es'];
const pageUrl = nativeLandingUrl('virtual-hairstyle-try-on', 'es');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-hairstyle-try-on', 'es'),
  ...
  openGraph: {
    ...
    locale: 'es_ES',
    images: [{ url: '/og/virtual-hairstyle-try-on.png', width: 1200, height: 630, alt: 'es probador peinados — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
