...
const data = localizedLandings['virtual-pet-clothing-try-on']['es'];
const pageUrl = nativeLandingUrl('virtual-pet-clothing-try-on', 'es');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-pet-clothing-try-on', 'es'),
  ...
  openGraph: {
    ...
    locale: 'es_ES',
    images: [{ url: '/og/virtual-pet-clothing-try-on.png', width: 1200, height: 630, alt: 'es probador ropa mascotas — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
