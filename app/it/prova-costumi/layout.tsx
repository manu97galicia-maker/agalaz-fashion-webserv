...
const data = localizedLandings['virtual-costume-try-on']['it'];
const pageUrl = nativeLandingUrl('virtual-costume-try-on', 'it');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-costume-try-on', 'it'),
  ...
  openGraph: {
    ...
    locale: 'it_IT',
    images: [{ url: '/og/virtual-costume-try-on.png', width: 1200, height: 630, alt: 'it prova costumi — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
