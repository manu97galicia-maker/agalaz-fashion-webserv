...
const pageUrl = nativeLandingUrl('virtual-mens-suit-try-on', 'it');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-mens-suit-try-on', 'it'),
  ...
  openGraph: {
    ...
    locale: 'it_IT',
    images: [{ url: '/og/virtual-mens-suit-try-on.png', width: 1200, height: 630, alt: 'it prova abito uomo — Agalaz AI Virtual Try-On' }],
