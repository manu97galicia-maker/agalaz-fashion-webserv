...
const data = localizedLandings['virtual-hairstyle-try-on']['it'];
const pageUrl = nativeLandingUrl('virtual-hairstyle-try-on', 'it');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-hairstyle-try-on', 'it'),
  ...
  openGraph: {
    ...
    locale: 'it_IT',
    images: [{ url: '/og/virtual-hairstyle-try-on.png', width: 1200, height: 630, alt: 'it prova acconciature — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
