...
const data = localizedLandings['virtual-cosplay-try-on']['it'];
const pageUrl = nativeLandingUrl('virtual-cosplay-try-on', 'it');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-cosplay-try-on', 'it'),
  ...
  openGraph: {
    ...
    locale: 'it_IT',
    images: [{ url: '/og/virtual-cosplay-try-on.png', width: 1200, height: 630, alt: 'it prova cosplay — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
