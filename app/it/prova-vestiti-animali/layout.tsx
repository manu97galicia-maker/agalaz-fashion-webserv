...
const pageUrl = nativeLandingUrl('virtual-pet-clothing-try-on', 'it');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-pet-clothing-try-on', 'it'),
  ...
  openGraph: {
    ...
    locale: 'it_IT',
    images: [{ url: '/og/virtual-pet-clothing-try-on.png', width: 1200, height: 630, alt: 'it prova vestiti animali — Agalaz AI Virtual Try-On' }],
