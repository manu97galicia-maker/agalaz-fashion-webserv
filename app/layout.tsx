    ...
    },
    {
      ...
      offers: [
        ...
        },
        {
          ...
          price: '0.99',
          priceCurrency: 'USD',
          description: 'Starter pack — 1 render + 1 FREE (2 renders total). One-time payment.',
        },
        {
          '@type': 'Offer',
          name: 'Style Pro pack',
          price: '4.99',
          priceCurrency: 'USD',
          description: 'Style Pro pack — 12 renders ($0.42 per render, save 58%). One-time payment.',
        },
      ],
    },
  ],
