...
const FAQ = [
  ...
  {
    q: '가격은 얼마인가요?',
    a: '매일 1장의 HD 렌더가 무료 (로그인 필요). 이후 Starter $4.99(HD 8장, 장당 $0.62) 또는 Pro $9.99(HD 15 + 5 무료 = 20장, 장당 $0.50). 코드 AGALAZ15로 Pro에서 15% 할인. 일회성 결제, 정기 구독 없음.',
  },
  {
    q: '앱을 다운로드해야 하나요?',
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white text-slate-900 font-[family-name:var(--font-noto-kr)]">
      ...
      <TriptychDemo slug="virtual-hanbok-try-on" labels={TRIPTYCH_LABELS_KO} lang="ko" />
