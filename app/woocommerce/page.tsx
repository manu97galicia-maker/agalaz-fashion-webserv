...
import { WOO_CONTENT } from '@/lib/i18n/b2bContent';

export default function WooCommercePage() {
  const { lang } = useLang();
  const c = WOO_CONTENT[lang] ?? WOO_CONTENT.en;
  const footerLabels = {
    en: { home: 'Home', tryOn: 'Try-on demo', shop: 'Shopify', dev: 'Developers', partners: 'Partners', blog: 'Blog', privacy: 'Privacy', terms: 'Terms' },
    es: { home: 'Inicio', tryOn: 'Demo probador', shop: 'Shopify', dev: 'Desarrolladores', partners: 'Partners', blog: 'Blog', privacy: 'Privacidad', terms: 'Términos' },
    fr: { home: 'Accueil', tryOn: 'Démo essayage', shop: 'Shopify', dev: 'Développeurs', partners: 'Partners', blog: 'Blog', privacy: 'Confidentialité', terms: 'Conditions' },
    pt: { home: 'Início', tryOn: 'Demo provador', shop: 'Shopify', dev: 'Programadores', partners: 'Partners', blog: 'Blog', privacy: 'Privacidade', terms: 'Termos' },
    de: { home: 'Start', tryOn: 'Anprobe-Demo', shop: 'Shopify', dev: 'Entwickler', partners: 'Partners', blog: 'Blog', privacy: 'Datenschutz', terms: 'AGB' },
    it: { home: 'Home', tryOn: 'Demo prova', shop: 'Shopify', dev: 'Sviluppatori', partners: 'Partners', blog: 'Blog', privacy: 'Privacy', terms: 'Termini' },
  }[lang];
      ...
      <footer className="border-t border-slate-100">
        <div className="max-w-6xl mx-auto px-6 py-10 flex flex-wrap items-center justify-between gap-4 text-xs text-slate-400 font-light">
          ...
          <nav className="flex flex-wrap gap-5">
            ...
            <Link href="/shopify" className="hover:text-slate-700 transition-colors">{footerLabels.shop}</Link>
