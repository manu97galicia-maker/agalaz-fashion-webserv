...
const FAQ = [
  ...
  {
    q: '料金はいくらですか?',
    a: '毎日1枚のHDレンダーが無料(ログインが必要)。その後はStarter $4.99(HD8枚、1枚$0.62)またはPro $9.99(HD15枚+5枚無料=20枚、1枚$0.50)。コードAGALAZ15でProが15%OFF。一回払い、サブスクリプションなし。',
  },
  {
    q: 'アプリのダウンロードは必要ですか?',
...
export default function Page() {
  return (
    <main className="min-h-screen bg-white text-slate-900 font-[family-name:var(--font-noto-jp)]">
      ...
      <TriptychDemo slug="virtual-kimono-try-on" labels={TRIPTYCH_LABELS_JA} lang="ja" />
