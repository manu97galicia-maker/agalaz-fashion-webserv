...
const data = localizedLandings['virtual-mens-suit-try-on']['fr'];
const pageUrl = nativeLandingUrl('virtual-mens-suit-try-on', 'fr');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-mens-suit-try-on', 'fr'),
  ...
  openGraph: {
    ...
    locale: 'fr_FR',
    images: [{ url: '/og/virtual-mens-suit-try-on.png', width: 1200, height: 630, alt: 'fr essayage costume homme — Agalaz AI Virtual Try-On' }],
