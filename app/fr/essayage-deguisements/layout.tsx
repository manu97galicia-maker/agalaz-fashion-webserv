...
const data = localizedLandings['virtual-costume-try-on']['fr'];
const pageUrl = nativeLandingUrl('virtual-costume-try-on', 'fr');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-costume-try-on', 'fr'),
  ...
  openGraph: {
    ...
    locale: 'fr_FR',
    images: [{ url: '/og/virtual-costume-try-on.png', width: 1200, height: 630, alt: 'fr essayage deguisements — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
