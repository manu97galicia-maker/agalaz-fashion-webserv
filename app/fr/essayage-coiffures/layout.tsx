...
const data = localizedLandings['virtual-hairstyle-try-on']['fr'];
const pageUrl = nativeLandingUrl('virtual-hairstyle-try-on', 'fr');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-hairstyle-try-on', 'fr'),
  ...
  openGraph: {
    ...
    locale: 'fr_FR',
    images: [{ url: '/og/virtual-hairstyle-try-on.png', width: 1200, height: 630, alt: 'fr essayage coiffures — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
