...
const data = localizedLandings['virtual-nail-try-on']['fr'];
const pageUrl = nativeLandingUrl('virtual-nail-try-on', 'fr');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-nail-try-on', 'fr'),
  ...
  openGraph: {
    ...
    locale: 'fr_FR',
    images: [{ url: '/og/virtual-nail-try-on.png', width: 1200, height: 630, alt: 'fr simulateur vernis ongles — Agalaz AI Virtual Try-On' }],
