...
const data = localizedLandings['virtual-cosplay-try-on']['fr'];
const pageUrl = nativeLandingUrl('virtual-cosplay-try-on', 'fr');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-cosplay-try-on', 'fr'),
  ...
  openGraph: {
    ...
    locale: 'fr_FR',
    images: [{ url: '/og/virtual-cosplay-try-on.png', width: 1200, height: 630, alt: 'fr essayage cosplay — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
