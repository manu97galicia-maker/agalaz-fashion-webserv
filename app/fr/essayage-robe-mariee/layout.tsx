...
const data = localizedLandings['virtual-wedding-dress-try-on']['fr'];
const pageUrl = nativeLandingUrl('virtual-wedding-dress-try-on', 'fr');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-wedding-dress-try-on', 'fr'),
