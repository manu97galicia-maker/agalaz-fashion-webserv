...
const pageUrl = nativeLandingUrl('virtual-pet-clothing-try-on', 'fr');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-pet-clothing-try-on', 'fr'),
  ...
  openGraph: {
    ...
    locale: 'fr_FR',
    images: [{ url: '/og/virtual-pet-clothing-try-on.png', width: 1200, height: 630, alt: 'fr essayage vetements animal — Agalaz AI Virtual Try-On' }],
