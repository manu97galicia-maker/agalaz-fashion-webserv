...
const FAQ = [
  ...
  {
    q: 'كم سعر الخدمة؟',
    a: 'تجربة HD مجانية واحدة يوميا، تتطلب تسجيل الدخول. بعدها: باقة Starter بـ 4.99 دولار (8 صور HD، 0.62 دولار للصورة) أو Pro بـ 9.99 دولار (15 + 5 مجانية = 20 صورة HD، 0.50 دولار للصورة). استخدم الكود AGALAZ15 لخصم 15% على Pro. دفعة واحدة، بدون اشتراك.',
  },
  {
