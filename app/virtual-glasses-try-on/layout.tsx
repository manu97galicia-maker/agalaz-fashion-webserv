...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (<><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(ld) }} />
      <ImageSchemaScript slug="virtual-glasses-try-on" lang="en" pageUrl="https://agalaz.com/virtual-glasses-try-on" />
      <HowToSchemaScript slug="virtual-glasses-try-on" lang="en" pageUrl="https://agalaz.com/virtual-glasses-try-on" />{children}</>);
}
