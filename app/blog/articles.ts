...
No adivines qué monturas funcionan. **[Pruébalas gratis con Agalaz IA →](https://agalaz.com/try-on)**`,
  },
  {
    ...
    title: 'Coquette Nails 2026 — Pink Bow Spring Designs (Free AI Try-On)',
    titleEs: 'Uñas Coquette 2026 — Diseños Rosa y Lazos Primavera (Probador IA Gratis)',
    description: 'Coquette nails 2026: pink bow, pearl and soft cute designs on YOUR hands with free AI try-on before you book your salon appointment.',
...
**[Prueba el probador virtual gratis →](https://agalaz.com/try-on)**`,
  },
  {
    ...
    title: '1.5 Carat Diamond Ring vs 2 Carat on Hand: Real Size Compared',
    titleEs: 'Anillo de Diamante 1.5 vs 2 Quilates: Comparativa Real en la Mano',
    description: '1.5 carat diamond ring vs 2 carat — see exactly how each looks on real hands. Compare sizes, prices, face-up area, and use our AI ring simulator to try both on YOUR hand.',
