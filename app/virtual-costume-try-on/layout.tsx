...
export default function Layout({ children }: { children: React.ReactNode }) {
  const ld = {
    ...
    '@graph': [
      { '@type': 'SoftwareApplication', name: 'Agalaz Virtual Costume Try-On', operatingSystem: 'WEB', applicationCategory: 'LifestyleApplication', url: 'https://agalaz.com/virtual-costume-try-on', offers: { '@type': 'Offer', price: '0.00', priceCurrency: 'USD' } },
