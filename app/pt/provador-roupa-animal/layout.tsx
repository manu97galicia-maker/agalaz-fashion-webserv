...
const pageUrl = nativeLandingUrl('virtual-pet-clothing-try-on', 'pt');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-pet-clothing-try-on', 'pt'),
  ...
  openGraph: {
    ...
    locale: 'pt_PT',
    images: [{ url: '/og/virtual-pet-clothing-try-on.png', width: 1200, height: 630, alt: 'pt provador roupa animal — Agalaz AI Virtual Try-On' }],
