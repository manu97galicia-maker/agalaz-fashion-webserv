...
const data = localizedLandings['virtual-mens-suit-try-on']['pt'];
const pageUrl = nativeLandingUrl('virtual-mens-suit-try-on', 'pt');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-mens-suit-try-on', 'pt'),
  ...
  openGraph: {
    ...
    locale: 'pt_PT',
    images: [{ url: '/og/virtual-mens-suit-try-on.png', width: 1200, height: 630, alt: 'pt provador fato homem — Agalaz AI Virtual Try-On' }],
