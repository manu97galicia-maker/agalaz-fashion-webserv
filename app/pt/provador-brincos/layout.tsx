...
export const metadata: Metadata = {
  title: 'Provador Virtual de Brincos com IA',
  ...
  openGraph: {
    ...
    locale: 'pt_PT',
    images: [{ url: '/og/virtual-earring-try-on.png', width: 1200, height: 630, alt: 'Provador Virtual de Brincos e Piercings com IA' }],
  },
};
