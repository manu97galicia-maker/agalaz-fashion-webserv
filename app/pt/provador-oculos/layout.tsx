...
const pageUrl = nativeLandingUrl('virtual-glasses-try-on', 'pt');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-glasses-try-on', 'pt'),
  ...
  openGraph: {
    ...
    locale: 'pt_PT',
    images: [{ url: '/og/virtual-glasses-try-on.png', width: 1200, height: 630, alt: 'pt provador oculos — Agalaz AI Virtual Try-On' }],
