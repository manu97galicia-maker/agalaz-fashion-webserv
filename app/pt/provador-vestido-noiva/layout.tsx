...
const data = localizedLandings['virtual-wedding-dress-try-on']['pt'];
const pageUrl = nativeLandingUrl('virtual-wedding-dress-try-on', 'pt');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-wedding-dress-try-on', 'pt'),
  ...
  openGraph: {
    ...
    locale: 'pt_PT',
    images: [{ url: '/og/virtual-wedding-dress-try-on.png', width: 1200, height: 630, alt: 'pt provador vestido noiva — Agalaz AI Virtual Try-On' }],
