...
const data = localizedLandings['virtual-cosplay-try-on']['pt'];
const pageUrl = nativeLandingUrl('virtual-cosplay-try-on', 'pt');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-cosplay-try-on', 'pt'),
  ...
  openGraph: {
    ...
    locale: 'pt_PT',
    images: [{ url: '/og/virtual-cosplay-try-on.png', width: 1200, height: 630, alt: 'pt provador cosplay — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
