...
const data = localizedLandings['virtual-hairstyle-try-on']['pt'];
const pageUrl = nativeLandingUrl('virtual-hairstyle-try-on', 'pt');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-hairstyle-try-on', 'pt'),
  ...
  openGraph: {
    ...
    locale: 'pt_PT',
    images: [{ url: '/og/virtual-hairstyle-try-on.png', width: 1200, height: 630, alt: 'pt provador penteados — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
