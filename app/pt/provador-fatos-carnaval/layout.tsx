...
const data = localizedLandings['virtual-costume-try-on']['pt'];
const pageUrl = nativeLandingUrl('virtual-costume-try-on', 'pt');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-costume-try-on', 'pt'),
  ...
  openGraph: {
    ...
    locale: 'pt_PT',
    images: [{ url: '/og/virtual-costume-try-on.png', width: 1200, height: 630, alt: 'pt provador fatos carnaval — Agalaz AI Virtual Try-On' }],
    },
  twitter: {
...
const jsonLd = buildLocalizedJsonLd({
  ...
  triptychSlug: 'virtual-costume-try-on',
  triptychLang: 'pt',
});
