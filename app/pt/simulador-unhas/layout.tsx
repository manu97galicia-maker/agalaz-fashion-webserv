...
const data = localizedLandings['virtual-nail-try-on']['pt'];
const pageUrl = nativeLandingUrl('virtual-nail-try-on', 'pt');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: nativeLandingUrl('virtual-nail-try-on', 'pt'),
