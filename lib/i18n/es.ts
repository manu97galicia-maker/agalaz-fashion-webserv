export const es = {
  ...
  tryOn: {
    ...
    noCredits: 'Sin creditos. Suscribete para obtener 7 transformaciones semanales.',
    creditsRemaining: 'creditos restantes',
    creditsReset: 'Se renuevan el',
  ...
  paywall: {
    ...
    subtitle: '7 transformaciones por semana. Se renuevan cada 7 dias con tu suscripcion activa.',
    features: [
      '7 transformaciones por semana',
      'Se renuevan cada 7 dias automaticamente',
  ...
  referral: {
    title: 'Invita y Gana',
    subtitle: 'Comparte tu codigo. Cuando tu referido pague, ambos recibis creditos extra.',
    codePlaceholder: 'Codigo de referido',
    apply: 'Aplicar',
    share: 'Compartir codigo',
    copied: 'Copiado!',
    yourCode: 'Tu codigo de referido',
    bonusWeekly: '+3 creditos por referido (plan semanal)',
    bonusYearly: '+20 creditos por referido (plan anual)',
    invalidCode: 'Codigo invalido',
    selfReferral: 'No puedes usar tu propio codigo',
    alreadyReferred: 'Ya tienes un codigo de referido aplicado',
    applied: 'Codigo aplicado correctamente!',
  },
};
