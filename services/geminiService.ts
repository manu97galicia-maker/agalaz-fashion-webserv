...
- HAIRSTYLE / HAIR COLOR / HAIRCUT / WIG (the reference shows a hair look — short bob, pixie, curtain bangs, balayage, platinum, copper, braids, ponytail, Korean see-through bangs / シースルーバング, Japanese blunt fringe / ぱっつん前髪, K-pop idol air bangs, etc.) → REPLACE the person's existing hair with the hairstyle shown in IMG2. Match cut length, layering, parting, colour and texture. Adjust hairline natural to the new style. For Korean / Japanese / K-pop bangs styles: respect the lightness — see-through bangs are translucent / wispy, NOT heavy. Keep face, skin, expression unchanged. Background unchanged.
...
- K-POP / J-POP IDOL OUTFIT (the reference shows a stage, airport, photoshoot or fancam outfit from a K-pop / J-pop artist — ENHYPEN's Jungwon, BTS's Jungkook, NewJeans, IVE, aespa, LE SSERAFIM, Stray Kids, TWICE, BLACKPINK, AKB48, etc.) → replicate the EXACT outfit shown — oversized hoodies + baggy denim, leather harnesses, mesh + cargo, satin co-ord sets, Dior runway fits, Gap hoodies. Preserve face and pose of the user from IMG1. Treat brand pieces (Dior, Gap, Uniqlo, Prada, Miu Miu) at face value — render the recognizable silhouette and color even when only partially visible in IMG2.
